    ...
    <div class="col-lg-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('panel.settings.contact.branches.create') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="branch-name">Şube Adı</label>
                        <input type="text" class="form-control" id="branch-name" name="name" placeholder="Şube Adı">
                    </div>
                    <div class="form-group">
                        <label for="branch-address">Şube Adresi</label>
                        <textarea class="form-control" id="branch-address" name="address" placeholder="Şube Adresi"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="branch-phone">Telefon Numarası</label>
                        <input type="tel" class="form-control" id="branch-phone" name="phone" placeholder="Telefon Numarası">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="branch-embed-url" name="embed-url">
                    </div>
                    <div class="form-group">
                        <label for="branch-map-url">Google Maps Bağlantısı</label>
                        <input type="text" class="form-control" id="branch-map-url" name="map-url">
                    </div>
