    ...
    <div class="col-lg-12">
        <div class="card card-default">
            <div class="card-header card-header-border-bottom">
                <h2>{{ __('general.edit_category') }}</h2>
            </div>
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('panel.products.categories.update') }}" method="POST">
                    @csrf
                    ...
                    <a class="btn btn-secondary" href="{{ route('panel.products.categories.index') }}">Geri Dön</a>
                </form>
            </div>
        </div>
    </div>
